...
Project overview (at least one paragraph describing the project and its goals)
Background research, information, and key terms
This should directly connect to your DSJ topic (example: who is impacted, what inequity exists, why support/awareness matters, etc.).
If you have a LOT of research, you may put it in a separate linked .md file.
Project dependencies (third-party libraries, datasets, APIs, etc., if applicable)
Configuration, installation, and execution instructions
Very important if you used anything beyond base Python.
Sample use-cases with screenshots (include alternative text for accessibility)
Table of files including:
each file name
What it does / key features
who contributed to it
Citations (for research, data, images, code snippets, tutorials, AI help, etc.)
